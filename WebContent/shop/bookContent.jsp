...
<body>
	<div id="cata" class="box2">
		<ul>
			...
			<li><a href="/shoppingmall/list.do?book_kind=200">외국어</a>
		...
		<table class="vhcenter">
			<tr height="30">
				<td rowspan="6" width="150">
					<img src="/shoppingmall/bookImage/${book.getBook_image()}" class="contentimage">
				</td>
				<td width="500">
			...
			<tr> 
				<td width="500"> 
					...
					<strong class="bred">
						판매가 : <c:set var="rPrice" value="${price*((100.0-rate)/100)}"/>
						<fmt:formatNumber value="${rPrice}" type="number" pattern="#,##0"/>원
					</strong>
				</td>
			</tr>
			<tr>
