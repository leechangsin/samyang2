...
<body>
	...
	<div id="goShop">
		<button id="conShopping">쇼핑 게속</button>
					...
					<c:forEach var="i" begin="0" end="${buyLists.size()-1}">
						...
						<c:if test="${i+1 <= buyList.size()-1}">
							...
							<tr>
								...
								<td width="300"><img src="/shoppingmall/bookImage/${buylist.getBook_image()}" class="cartimage">${buylist.getBook_title()}</td>
								<td width="100"><fmt:formatNumber value="${buylist.getBuy_price()}" type="number" pattern="#,##0"/>원</td>
